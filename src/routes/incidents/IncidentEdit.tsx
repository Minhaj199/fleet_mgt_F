...
import {  IncidentFormValuesType } from '../../types/type'
...
export default function IncidentEdit(){
  ...
  return (
    <IncidentForm isEdit defaultValues={{
      title: data.title, description: data.description,resolution_Note:data.resolutionNotes, severity: data.severity as any, incidentType: data.type as any,
